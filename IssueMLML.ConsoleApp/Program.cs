...
namespace IssueMLML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\SSG\Downloads\all_issues_log.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Issue} | Predicted value: {predictionResult.Prediction}");
